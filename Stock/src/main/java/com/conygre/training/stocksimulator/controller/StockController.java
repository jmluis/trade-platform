package com.conygre.training.stocksimulator.controller;
...
import com.conygre.training.stocksimulator.service.*;
...
public class StockController {
	...
	public ResponseEntity<List<Stock>> getStock(@RequestParam(value="q", required=false) String query) throws SymbolNotFoundException {
		...
		List<Stock> quotes = service.getStocks( query );
	...
	public ResponseEntity<List<CompanyInfo>> getCompanies(@PathVariable("name") final String name) {
		logger.debug("StockController.getCompanies: retrieving companies for: " + name);
